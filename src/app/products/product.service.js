...
var ProductService = (function () {
    ...
    ProductService.prototype.getfillrate = function (colCode) {
        return this._http.get(this._productUrl + colCode + ".json")
            .map(function (response) { return response.json(); })
            .do(function (data) { return console.log('All: ' + JSON.stringify(data)); })
            .catch(this.handleError);
    ...
    ProductService.prototype.getStartDate = function (colCode) {
        return this.getProducts()
            .map(function (products) { return products.find(function (p) { return p.colCode === colCode; }); });
    };
    ProductService.prototype.getDate = function (colCode) {
        return this._http.get(this._productUrl + "start/" + colCode + ".json")
            .map(function (response) { return response.json(); })
            .do(function (data) { return console.log('All: ' + JSON.stringify(data)); })
            .catch(this.handleError);
    };
